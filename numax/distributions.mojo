...
recovers exactly that, which is how `tests/test_distributions.mojo` checks
...
`numax.solve.newton`, and the reason is a real limitation worth naming:
...
from .beta import betainc
from .gamma import gammainc, gammaincc, lgamma
