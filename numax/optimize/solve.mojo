...
`numax.special.lambertw` already did this by hand: its Halley iteration hardcodes
...
def halley[
    ...
    exactly the second derivative (the same nesting `tests/core/test_dual.mojo`
