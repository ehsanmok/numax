...
when that matrix is well conditioned; `PivotedLU` there pivots and gives
...
Both factorization objects -- this one and `PivotedLU` -- carry the solves
that reuse them, which is the point of returning a factorization rather
than a solution: one factorization, several right-hand sides.
