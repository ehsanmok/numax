...
numax/
  ...
  interpolate/  interpolation: `interp` over Tensor; splines and Chebyshev over Array
...
`interpolate.array` uses `linalg.array`'s tridiagonal solve, and `optimize` uses
