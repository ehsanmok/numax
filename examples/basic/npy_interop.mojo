...
def main() raises:
    ...
    var xs = Static[DType.float32, N_ROWS, N_COLS](ctx, storage^)
    ...
    numpy.save(Static[DType.float64, 4](ctx, f64_storage^), f64_path)
    ...
    numpy.save(Static[DType.int32, 2, 2](ctx, i32_storage^), i32_path)
