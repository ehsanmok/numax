...
def main() raises:
    ...
    print("full[3](ctx, 7):", f[0], f[1], f[2])
    ...
    print("linspace[5](ctx, 0, 1):", ls[0], ls[1], ls[2], ls[3], ls[4])
    ...
    var left = arange[dtype, 3](ctx)
    var right = arange[dtype, 2](ctx, Scalar[dtype](100))
