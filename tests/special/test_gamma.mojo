"""Tests for `numax.special.gamma` against closed-form values and derivatives."""
...
def test_gamma_reflects_to_negative_non_integers() raises:
    ...
    # reference -- see `numax/special/gamma.mojo`'s module docstring for why
    # `numax.special.gamma` doesn't just call it directly).
