"""Tests for `numax.lambertw`/`lambertw_m1` against known values and the
...
def test_lambertw_m1_matches_known_values() raises:
    ...
    assert_almost_equal(
        lambertw_m1(v(-0.1)).v, SIMD[dtype, width](-3.5771520640), atol=1e-8
    )
    assert_almost_equal(
        lambertw_m1(v(-0.01)).v, SIMD[dtype, width](-6.4727751244), atol=1e-8
    )
